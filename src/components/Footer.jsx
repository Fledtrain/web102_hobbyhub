...
const Footer = () => {
    ...
    return (
        <>
            <footer className="footer footer-center p-10 mt-5 bg-base-300 text-primary-content">
                <aside>
                    ...
                    <p>Copyright © {year}- All right reserved by Joey Whitehead</p>
                </aside>
                <nav>
                    <div className="grid grid-flow-col gap-4">
                        <a target="_blank" href="https://github.com/Fledtrain" rel="noreferrer">
                        ...
                        <a target="_blank" href="https://www.linkedin.com/in/joeywhitehead/" rel="noreferrer" >
                            <svg xmlns="http://www.w3.org/2000/svg"
                                width="32"
                                height="32"
                                viewBox="0 0 30 30"
